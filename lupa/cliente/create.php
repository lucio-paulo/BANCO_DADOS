...
//Inserindo no Banco:
    if ($validacao) {
        ...
        $sql = "INSERT INTO cliente(cnpj_cpf_cliente,telefon,endereco,nome_cliente) VALUES(?,?,?,?)";
        $q = $pdo->prepare($sql);
        $q->execute(array($cnpj_cpf_cliente,$telefon,$endereco,$nome_cliente));
        Banco::desconectar();
            ...
            <div class="card-body">
                <form class="form-horizontal" action="create.php" method="post">
                    ...
                    <div class="control-group  <?php echo !empty($cnpj_cpf_clienteErro) ? 'error ' : ''; ?>">
                        ...
                        <div class="controls">
                            <input size="50" class="form-control" name="cnpj_cpf_cliente" type="text" placeholder="cnpj cpf cliente"
